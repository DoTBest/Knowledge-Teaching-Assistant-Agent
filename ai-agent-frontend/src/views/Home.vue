<template>
  <div class="home-container">
    ...
    <div class="apps-container">
      <div class="app-card" @click="navigateTo('/teaching-assistant')">
        <div class="card-glow"></div>
        <div class="app-icon teach-icon">📚</div>
        <div class="app-info">
          <div class="app-title">AI知识教学助手</div>
          <div class="app-desc">Java/Spring/AI技术知识库，分层次教学辅导</div>
        </div>
